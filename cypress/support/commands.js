...
Cypress.Commands.add('Login', (user, password) => {
    cy.visit('/web/database/selector');
...
EX: cy.MainMenu('sale.sale_menu_root')
-----------------------------------------------------------------*/
Cypress.Commands.add('MainMenu', (xml_id) => {
    cy.get('[data-menu-xmlid="' + xml_id + '"]').should('have.attr', 'data-menu-xmlid', xml_id).click();
    cy.Waiting(1000);
});
...
-----------------------------------------------------------------*/
Cypress.Commands.add('SubMenu', (xml_id) => {
    cy.get('[data-menu-xmlid="' + xml_id + '"]').should('have.attr', 'data-menu-xmlid', xml_id).click();
    cy.Waiting(2000);
});
...
Cypress.Commands.add('View', (type) => {
    // TODO:
    cy.get('button[data-view-type="' + type + '"]').should('have.attr', 'data-view-type', type).click();
});
